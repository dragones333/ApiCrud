...
var TodoController = /** @class */ (function () {
    ...
    TodoController.getAllTodos = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var todos;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Todo_1.default.findAll()];
                    case 1:
                        todos = _a.sent();
                        res.json(todos);
                        return [2 /*return*/];
    ...
    TodoController.getTodoById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Todo_1.default.findByPk(req.params.id)];
                    case 1:
                        todo = _a.sent();
                        res.json(todo);
                        return [2 /*return*/];
    ...
    TodoController.createTodo = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Todo_1.default.create(req.body)];
                    case 1:
                        todo = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, todo.update(req.body)];
                    case 2:
                        _a.sent();
                        res.json(todo);
                        return [3 /*break*/, 4];
